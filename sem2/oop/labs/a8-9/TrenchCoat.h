...
public:
	...
	//stream operators
	//insertion operator that allows writing to the file/console (allows chaining)
	friend std::ostream& operator<<(std::ostream& out, const TrenchCoat& coat);
	//extraction operator that allows reading from the file/console (allows chaining)
